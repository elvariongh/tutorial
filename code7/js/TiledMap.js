(function(w, TGE) {
    /**
     * Constructor of TiledMap object
     * @constructor
    ...
    // parse and optimize JSON structure for further usage
    TiledMap.prototype.parse = function() {
        ...
        // process tilesets for further performance boost
        arr = json['tilesets'];
        i = arr.length;
        for (;i--;) {
            item = arr[i];
    ...
    // returns array of assets (mostly images) required for map rendering
