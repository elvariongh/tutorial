...
//        this['z'] = this['x']*map['height']*20 + this['y'];
		// made like in Tiled (https://github.com/clintbellanger/flare/issues/461)
        this['z'] = (this['x']+this['y'])*map['height']*20 + (this['x']-this['y']);
...
//        this['z'] = x + y*this['map']['width'];
//        this['z'] = x*this['map']['height']*20 + y;

		// made like in Tiled (https://github.com/clintbellanger/flare/issues/461)
        this['z'] = (x+y)*this['map']['height']*20 + (x-y);
