...
//        this.id = undefined;
    ...
    Tile.prototype = Object.create(TGE['EntitiesFactory']['entity'].prototype);
...
//        this.id = data.id;
		...
		// this['z'] += ~~(this.width / map['tilewidth']);
        // this['z'] -= ~~(this.height / map['tilewidth']) * map['width'] * 20;
...
//		this['z'] -= ~~(this.width / map['tilewidth']);
        ...
        if (!this.animation) {
            ...
            this.frame = 0;
            this.animated = false;
            this.animation = [new Uint32Array([scr[data['id']*5+1], scr[data['id']*5+2], 1000])];
        }
        ...
        this['x'] = scr[data['id']*5+3] + ~~(map['mapwidth']/2);
        this['y'] = scr[data['id']*5+4];
...
//        this['z'] -= ~~(this.height / this['map']['tileheight']);
        ...
        this['x'] = scr[this.tileid*5+3] + ~~(this['map']['mapwidth']/2);
        this['y'] = scr[this.tileid*5+4];
