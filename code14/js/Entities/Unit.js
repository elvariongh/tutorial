...
(function(w, TGE) {
    ...
    Unit.prototype.init = function(data, assetManager, map) {
		...
		// triggers
		this['properties'] = {};
		if (data['properties']['onClick']) {
			this['properties']['onClick'] = data['properties']['onClick'];
		}
...
//            this.redraw = true;
		...
		if (this.animation[this.state]['frames'] === 1) this.redraw = false;
...
//		console.log(this.name, this.state, this.frameIdx);
    };
...
//        TGE['EntitiesFactory']['entity'].prototype['move'].call(this, x, y);
		...
		if (!(this.direction === faceDirection.SW ||
			this.direction === faceDirection.S ||
			this.direction === faceDirection.SE)) {
//			this['z'] = x + y*this['map']['width']*20 + 19;
		}
//			this['z'] = x*this['map']['height']*20 + 19 + y;

			// made like in Tiled (https://github.com/clintbellanger/flare/issues/461)
			this['z'] = (x+y)*this['map']['height']*20 + 19 + (x-y);
...
//        this['z'] = this['x']*this['map']['height']*20 + 19 + this['y'];
		// made like in Tiled (https://github.com/clintbellanger/flare/issues/461)
        this['z'] = (this['x']+this['y'])*this['map']['height']*20 + 19 + (this['x']-this['y']);
