...
//        json['type'] = t;
    ...
    EntitiesFactory.prototype._makeShared = function(tp) {
        if (!this['_'+tp+'Shared']) {
            
			var shared = function() { TGE['EntitiesFactory'][tp].call(this); };
            shared.prototype = Object.create(this[tp].prototype);
            shared.prototype['release'] = function() { 
                TGE['EntitiesFactory']['release'](this); 
            };

            this['_'+tp+'Shared'] = shared;

        }

        return new this['_'+tp+'Shared'];
    };
