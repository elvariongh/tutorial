...
(function(w, TGE) {
    ...
    function ViewPort(tag, width, height) {
		...
		this.ratio = 1;//window.devicePixelRatio;//Math.min(window.devicePixelRatio || 1, 3);// / backingStoreRatio;
        ...
        this['viewport'] = new Int32Array([0, 0, width / this.ratio, height / this.ratio, false]);
...
//        var clrect = this.domViewport.getClientRects();
        ...
        this.domViewport.addEventListener('mousedown',      throttle(this.onMouseDown,  64, this), true);
        this.domViewport.addEventListener('mouseup',        throttle(this.onMouseUp,    64, this), true);
        this.domViewport.addEventListener('mousemove',      throttle(this.onMouseMove,  64, this), true);
        this.domViewport.addEventListener('mouseout',       throttle(this.onMouseUp,    64, this), true);
        this.domViewport.addEventListener('mouseclick',     throttle(this.onMouseClick, 64, this), true);
        this.domViewport.addEventListener('contextmenu',    this.onDeprecatedEvent, false);
        
        document.addEventListener('keyup', this.onDeprecatedEvent, false);
        ...
        if (TGE['Device'] && TGE['Device']['mobile']) {
			...
			console.info('enable fake fullscreen');
			window.scrollTo(0, 2);
        }
    ...
    ViewPort.prototype.onDeprecatedEvent = function(e) {
    ...
    ViewPort.prototype.onMouseClick = function(e) {
        ...
        e.stopImmediatePropagation();
        e.stopPropagation();
        TGE['bus']['notify']('click', {x: (e.clientX - this.offsetX) / this.ratio, y: (e.clientY - this.offsetY) / this.ratio, which: e.which, viewport: this['viewport']});
    }
    ...
    ViewPort.prototype.onMouseDown = function(e) {
        ...
        this.dnd[0] = (e.clientX - this.offsetX) / this.ratio;
        this.dnd[1] = (e.clientY - this.offsetY) / this.ratio;
        this.dnd[2] = false;
        this.dnd[5] = true;
    };
    ...
    ViewPort.prototype.onMouseUp = function(e) {
        ...
        if (this.dnd[2]) {
            ...
            this.dnd[2] = false;
            this.dnd[3] = (e.clientX - this.offsetX) / this.ratio - this.dnd[0];
            this.dnd[4] = (e.clientY - this.offsetY) / this.ratio - this.dnd[1];
    ...
    ViewPort.prototype.onMouseMove = function(e) {
        ...
        if (this.dnd[5]) {
            ...
            TGE['bus']['notify']('mousemove', {x: e.clientX - this.offsetX, y: e.clientY - this.offsetY, viewport: this['viewport']});
        }
...
//        this['resize'](e.target.innerWidth, e.target.innerHeight);
    ...
    ViewPort.prototype['resize'] = function(width, height) {
        for (var l = this.ctx.length; l--;) {
			...
			this.ctx[l].width = ~~(width / this.ratio);
			this.ctx[l].height = ~~(height / this.ratio);
			
			this.ctx[l].scale(this.ratio, this.ratio);
        }
        
        this['viewport'][2] = ~~(width / this.ratio);
        this['viewport'][3] = ~~(height / this.ratio);
...
//            t += '<canvas style="position:fixed; left: 0px; top: 0px; z-index: '+(i)+';" id="_tgelr'+(i)+'"></canvas>';
        ...
        this['resize'](this['viewport'][2] * this.ratio, this['viewport'][3] * this.ratio);
    };
