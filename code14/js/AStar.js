...
//                return graph.nodes[a].f < graph.nodes[b].f; 
        ...
        }).bind(this), (function(obj, value) { this.heapNodes[value] = obj;}).bind(this));
...
//                        openHeap.rescoreElement(nidx);
						openHeap.rescoreElement(this.heapNodes[nidx]);
                    }
                }
            }
        }
 ...
 */
var binaryHeap = function(comp, cbNode) {
  ...
  that.rescoreElement = function(node) {
	  bubbleDown(node);
//      console.warn('rescoring required', node);
  };
